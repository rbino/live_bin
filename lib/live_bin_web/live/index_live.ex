defmodule LiveBinWeb.IndexLive do
  use LiveBinWeb, :live_view

  alias LiveBin.Requests
  ...
  def render(assigns) do
    ...
    <main class="container">
      ...
      <section class="max-w-prose mx-auto leading-relaxed text-lg flex flex-col space-y-3">
        <p>
          <b>LiveBin</b> is a simple tool used to inspect HTTP requests.
        </p>
        <p>
        ...
        <p>
          You can find the source <a target="_blank" href="https://github.com/rbino/live_bin">on Github</a>.
        </p>
      </section>
    </main>
    """
